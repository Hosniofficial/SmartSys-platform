...
vendor/bin/php-cs-fixer fix api/v1/src/Handlers/YourFile.php --rules=@PSR12

# أو استخدام phpcs
vendor/bin/phpcs --standard=PSR12 api/v1/src/Handlers/YourFile.php
```

3. **قبل الـ Commit:**
```bash
# تشغيل على كل الملفات المعدّلة
vendor/bin/php-cs-fixer fix api/v1/src/Handlers/ --rules=@PSR12
git add .
git commit -m "..."
```
