<template>
  <div class="min-h-screen bg-[#f8fafc] p-4 lg:p-8 text-gray-700 animate-fadeIn">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 transition-all">
          <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-6">
            ...
            <div v-if="[1, 2, 3].includes(authStore.user?.role_id)" class="md:col-span-2">
              <div class="relative">
                <select v-model="selectedBranch" @change="debouncedSearch" class="form-select-modern">
    ...
    <BaseModal :show="showOpenDialog" @close="showOpenDialog = false" maxWidth="md" variant="modern">
      <template #header>
        <h3 class="text-lg font-bold text-slate-900">فتح جلسة كاشير جديدة</h3>
      </template>
      ...
      <template #footer>
        <button @click="showOpenDialog = false" class="flex-1 py-3 rounded-xl border border-gray-200 text-sm font-bold text-gray-600 hover:bg-gray-50 transition">
          إلغاء
        </button>
    ...
    <!-- Close Session Modal -->
    <BaseModal :show="showCloseDialog" @close="showCloseDialog = false" maxWidth="md" variant="modern">
      <template #header>
        <h3 class="text-lg font-bold text-slate-900">إنهاء الوردية</h3>
      </template>
      ...
      <template #footer>
        <button @click="showCloseDialog = false" class="flex-1 py-3 rounded-xl border border-gray-200 text-sm font-bold text-gray-600 hover:bg-gray-50 transition">
          إلغاء
        </button>
    ...
    <BaseModal :show="showSummaryDialog" @close="showSummaryDialog = false" maxWidth="lg" variant="modern">
      <template #header>
        <h3 class="text-lg font-bold text-slate-900">ملخص الجلسة</h3>
      </template>
    ...
    <!-- Rename Device Modal -->
    <BaseModal :show="showRenameDevice" @close="showRenameDevice = false" maxWidth="md" variant="modern">
      <template #header>
        <h3 class="text-lg font-bold text-slate-900">تسمية جهاز نقطة البيع</h3>
      </template>
      ...
      <template #footer>
        <button @click="showRenameDevice = false" class="flex-1 py-3 rounded-xl border border-gray-200 text-sm font-bold text-gray-600 hover:bg-gray-50 transition">
          إلغاء
        </button>
